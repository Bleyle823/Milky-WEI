    ...
    <div className="container mx-auto py-10">
      ...
      <div className="flex justify-around items-center flex-wrap">
        <div className="grid grid-cols-2 ">
          <button className={`${buttonStyle}`}>Audio Assets</button>
          <button className={`${buttonStyle}`}>3D Models</button>
          <button className={`${buttonStyle}`}>GUI Assets</button>
          <button className={`${buttonStyle}`}>2D Assets</button>
